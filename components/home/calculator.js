      ...
      <div className="container mx-auto px-4 max-w-lg">
          ...
          <form onSubmit={handleSubmit}>
            <div className="relative mb-4">
                    <input value={name} onChange={(e) => setName(e.target.value)} type="text" placeholder="Enter TikTok username here" className="w-full bg-gray-800 rounded-lg py-3 px-4 text-white focus:outline-none"/>
